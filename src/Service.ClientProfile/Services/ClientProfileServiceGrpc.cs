...
namespace Service.ClientProfile.Services
{
    public class ClientProfileServiceGrpc : IClientProfileService
    {
        ...
        public async Task<ClientProfileUpdateResponse> SetUserType(SetUserTypeRequest request)=> await _clientProfileService.SetUserType(request);
        public Task<ClientProfileUpdateResponse> SetInternalSimpleEmailAsync(SetInternalSimpleEmailRequest request) => _clientProfileService.SetInternalSimpleEmailAsync(request);
        public async Task<ClientProfileUpdateResponse> SubmitReview(SubmitReviewRequest request) => await _clientProfileService.SubmitReview(request);
    }
}